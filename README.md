# 철학과 2학년 박연호를 소개합니다.
## 간단 소개
- 사고를 정제하고, 사람에 맞게 전달하며, 실행력을 바탕으로 윤리적 문제를 탐구하는 사람
...
AI 역시 어떤 윤리적 기준을 적용 받느냐에 따라 전혀 다른 평가를 받습니다.
이에 따라 저는 다음과 같은 질문들을 중심으로 문제를 확장했습니다.
...
## 경험
- **학원 조교 및 강사**
  - 학생의 이해 수준에 맞춘 설명 방식 설계
- **학생회 활동**
  - MT 및 신입생 환영회 기획 및 진행하며 상황에 따라 프로그램 수정
 
특히 다양한 대상과 상황 속에서 동일한 내용을 다르게 설명했던 경험은, 개념 전달을 고정적으로 할 것이 아닌 맥락 속에서 구성해야 한다는 것을 체감하게 했습니다. 이는 AI의 윤리적 판단 기준을 설계하는 데에도 중요한 관점이 될 것이라고 생각합니다.
